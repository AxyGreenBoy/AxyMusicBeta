        ...
        if (data.status == "success") {
           ...
           <li>
                    <div class="col">
                        ...
                        <span id="download-status" style="color:orange">Compiling.</span>
                        </div>
                    </div>
                    <hr>
                    </li>
           */
            // download_item.innerHTML = '<div class="col"><img src="'+data.image+'" width="50px"><div style="display: inline;"><span id="download-name">'+id+'</span><span id="download-album">'+data.album+'</span><br><span id="download-size">'+data.size+'</span><span id="download-status" style="color:orange">Compiling.</span></div></div><hr>';
            ...
            <div style="display: inline;">
              ...
              <span class="track-status" style="color:orange"> </span>
            </div>
          </div>
          <hr>
            `;
            ...
            // change mpopupLink background and border color to orange and back to blue after 1 second
            var float_tap = document.getElementById('mpopupLink');
            float_tap.style.backgroundColor = "orange";
            float_tap.style.borderColor = "orange";
